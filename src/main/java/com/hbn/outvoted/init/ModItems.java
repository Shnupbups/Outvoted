...
public class ModItems {
    ...
    public static DeferredRegister<Item> ITEMS = new DeferredRegister<>(ForgeRegistries.ITEMS, Outvoted.MOD_ID);
    ...
    public static final RegistryObject<Item> INFERNO_SHIELD_PART = ITEMS.register("inferno_shield_part", () -> new ModItem(new Item.Properties().group(Outvoted.TAB_MISC)));
    public static final RegistryObject<Item> INFERNO_PIECE = ITEMS.register("inferno_piece", () -> new ModItem(new Item.Properties().group(Outvoted.TAB_MISC)));
