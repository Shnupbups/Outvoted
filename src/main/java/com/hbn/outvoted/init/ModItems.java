...
public class ModItems {
    ...
    public static final RegistryObject<Item> INFERNO_SHIELD_PART = ITEMS.register("inferno_shield_part", () -> new Item(new Item.Properties().group(tab)));
    public static final RegistryObject<Item> INFERNO_PIECE = ITEMS.register("inferno_piece", () -> new Item(new Item.Properties().group(tab)));
