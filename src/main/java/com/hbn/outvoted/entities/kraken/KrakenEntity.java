...
public class KrakenEntity extends MonsterEntity implements IAnimatedEntity {
    ...
    protected void registerAttributes() {
        ...
        this.getAttribute(SharedMonsterAttributes.ATTACK_KNOCKBACK);
    ...
    static class MoveHelperController extends MovementController {
        ...
        public void tick() {
            if (this.action == MovementController.Action.MOVE_TO && !this.entity.getNavigator().noPath()) {
                Vec3d vector3d = new Vec3d(this.posX - this.entity.getPosX(), this.posY - this.entity.getPosY(), this.posZ - this.entity.getPosZ());
