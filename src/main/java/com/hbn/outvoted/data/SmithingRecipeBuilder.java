...
import com.blackgear.nether.core.registries.data.NetherContainerRecipes;
...
class SmithingRecipeBuilder extends ConditionalRecipe {
    ...
    public static SmithingRecipeBuilder smithingRecipe(Ingredient base, Ingredient addition, Item output) {
        return new SmithingRecipeBuilder(NetherContainerRecipes.SMITHING.get(), base, addition, output);
    }
