...
public class ModTags {
    public static class Blocks {
        ...
        public static final Tag.Identified<Block> HOLLOW_LOGS = BlockTags.register(Outvoted.MOD_ID + ":hollow_logs");
    }
    ...
    public static class Items {
        ...
        public static final Tag.Identified<Item> HOLLOW_LOGS = ItemTags.register(Outvoted.MOD_ID + ":hollow_logs");
    }
